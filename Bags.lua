...
----
function B:VendorTrashCheck()
	local itemCount, value = B:GetTrashInfo()

	if itemCount == 0 then
		E:Print(L["No grey items below 80s to delete."])
...
function B:VendorGrayCheck()
	...
	if itemCount == 0 then
		E:Print(L["No grey items to delete."])
	elseif not MerchantFrame:IsShown() then
